...
<title>Bienvenido a Arequipa Travel</title>
...
<div class="ui attached message">
  <div class="header">Acceso Administrativo</div>
<?php
...
<form class="ui form attached fluid loading segment" method="POST">
  ...
  <div class="inline field">
    <div class="ui checkbox"><input type="checkbox" id="rememberPass"><label>Recordar</label></div>
  </div>
...
<i class="icon help"></i> Si olvidó su usuario es: <a href="#0"> admin</a> y su contraseña es: <a href="#">password</a> para acceder.
</div>
